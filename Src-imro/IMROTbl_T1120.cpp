...
void IMROTbl_T1120::toShankMap( ShankMap &S ) const
{
    IMROTbl::toShankMap( S );
    S.nc = imType1120Col_smap;
}


void IMROTbl_T1120::toShankMap_saved(
    ShankMap            &S,
...
// Return ROI count.
//
int IMROTbl_T1120::edit_defaultROI( tImroROIs vR ) const
{
    vR.clear();
