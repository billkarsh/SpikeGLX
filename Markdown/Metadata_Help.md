...
>Note: Channel maps only sort the visual Graphs window, and do not
alter the order of channels stored in .bin/.meta files, which are always
in acquired-channel-order.
...
Learn more imro details [here.](https://billkarsh.github.io/SpikeGLX/help/imroTables/)
